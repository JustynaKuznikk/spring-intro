...
public class StartupDataLoader {
    ...
    //kluczowe jest final i adnotacjia @RequiredArgsConstructor
    //Mamy wygenerowany konstruktor dla wszystkich pól typu final
    //dzięki tej adniotacji
    //przez lomboka więc nie tworzymy własnego, a jak mamy
    //tylko jeden, to Spring automatycznie(magicznie) używa go do wstrzykiwania zależności
    ...
    public void onStartupPrepareData(ContextRefreshedEvent event){
       ...
       userRepository.save(User.builder()
        ...
        advertRepository.save(Advert.builder()
                ...
                .build());
        advertRepository.save(Advert.builder()
                .title("Sprzedam drzewo")
                .description("Sprzedam dowolne drzewo do 2m średnicy!")
                .user(andrzej)
